...
from OneForAll.gp.nn.layer.pyg import RGCNEdgeConv
from OneForAll.gp.nn.models.GNN import MultiLayerMessagePassing
from OneForAll.gp.nn.models.util_model import MLP
from OneForAll.gp.utils.utils import load_pretrained_state

# LLM_DIM_DICT = {"ST": 768, "BERT": 768, "e5": 1024, "llama2_7b": 4096, "llama2_13b": 5120}
# 5632/6656 是拼接了子图信息的维度
LLM_DIM_DICT = {"ST": 768, "BERT": 768, "e5": 1024, "llama2_7b": 5632, "llama2_13b": 6656}
...
class LLMModel(torch.nn.Module):
    ...
    def get_llm_model(self):
        ...
        model_path = 'OneForAll/'+self.cache_dir+'/'+model_name+'/'
        ...
        if self.quantization:
            ...
            # model = ModelClass.from_pretrained(model_path, device_map='auto')
            # config_dict = {
            #             "_name_or_path": "cache_data/model/meta-llama/Llama-2-7b-hf/Llama-2-7b-hf/",
            #             "architectures": [
            #                 "LlamaForCausalLM"
            #             ],
            #             "bos_token_id": 1,
            ...
            #     model.tie_weights()
            # print('初始化空参数')
            # # device_map = infer_auto_device_map(model, max_memory={0: "6GiB", 1: "10GiB", 2: "10GiB"})
            # model = load_checkpoint_and_dispatch(
            #     model, checkpoint=model_path+'pytorch_model.bin.index.json',dtype=torch.float16, device_map='balanced_low_0'
            #     )
            # print('加载参数')
        ...
        tokenizer = TokenizerClass.from_pretrained(model_path, add_eos_token=True,legacy=True,use_fast=False)
