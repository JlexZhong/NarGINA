...
from OneForAll.gp.utils.graph import sample_fixed_hop_size_neighbor
from OneForAll.utils import scipy_rwpe, set_mask
    ...
    def update(self, metric):
        ...
        for i in range(len(self.datas)):
            ...
            if self.inpatience[i] > self.patience[i]:
                if isinstance(self.min_ratio,int):
                    self.dataset_multiple[i] = max(self.min_ratio,
