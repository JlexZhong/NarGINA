...
# bash run_uie_finetune.bash -v -d 2 -b 16 -k 1 --lr 1e-4 --warmup_ratio 0.06 -i event_zh/narrative --epoch 50   --spot_noise 0.1 --asoc_noise 0.1 -f spotasoc   --epoch 50   --map_config config/offset_map/longer_first_offset_zh.yaml   -m hf_models/uie-large-en   --random_prompt
